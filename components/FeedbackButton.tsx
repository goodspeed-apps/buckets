...
export function FeedbackButton({
  ...
  const shouldShow = visible ?? gasConfig.features.analytics?.enabled ?? false;
  ...
  // Shake detection
  useEffect(() => {
    if (!shakeEnabled || !Accelerometer || isWeb) return;
    let lastMag = 0;
    if (!accelIntervalSet) {
      ...
      <Modal visible={modalVisible} animationType="slide" transparent onRequestClose={closeModal}>
        ...
        >
          ...
          >
            ...
            {submitted ? (
              <Text style={{ textAlign: 'center', color: colors.success, fontSize: 16, paddingVertical: 24 }}>
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        style={{
                          ...
                          backgroundColor: selected ? cat.color + '22' : 'transparent',
                          marginRight: 8,
                        }}
                        accessibilityRole="button"
                      ...
                      >
                        <Icon size={14} color={selected ? cat.color : colors.textSecondary} />
                        <Text style={{ fontSize: 13, color: selected ? cat.color : colors.textSecondary, fontWeight: selected ? '600' : '400' }}>
                          {cat.label}
                        </Text>
                      </TouchableOpacity>
                    );
