  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        {showWarning && (
          <Animated.View entering={FadeInDown.delay(100)} style={{ backgroundColor: colors.warningMuted, borderRadius: radii.md, padding: spacing.md, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginBottom: spacing.md }}>
        ...
        <Animated.View entering={FadeInDown.delay(150)} style={{ marginTop: spacing.md }}>
          ...
          {contributions.length === 0 ? (
            ...
            <Animated.View key={c.id} entering={FadeInDown.delay(50 * index)} style={{ backgroundColor: colors.surface, borderRadius: radii.md, padding: spacing.md, marginBottom: spacing.sm, borderWidth: 1, borderColor: colors.border }}>
